...
dllink <- download_link(
  link = "http://mattwaite.github.io/sportsdatafiles/players19.csv",
  button_label = "Download csv file",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
