...
To begin, we'll import the `ggplot2` and `dplyr` libraries. We'll read in the data, then create a new dataframe that represents [our attendance data](https://unl.box.com/s/etqna5bfvf3b0gsnw0kcjjn1rxx9335s), similar to what we've done before. 
