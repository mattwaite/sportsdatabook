...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{threechange <-}\StringTok{ }\NormalTok{logs }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(season }\OperatorTok{==}\StringTok{ "2018-2019"} \OperatorTok{|}\StringTok{ }\NormalTok{season }\OperatorTok{==}\StringTok{ "2019-2020"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Team, Conference, season) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{Total3PA =} \KeywordTok{sum}\NormalTok{(Team3PA)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pivot_wider}\NormalTok{(}\DataTypeTok{names_from=}\NormalTok{season, }\DataTypeTok{values_from =}\NormalTok{ Total3PA) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{PercentChange =}\NormalTok{ (}\StringTok{`}\DataTypeTok{2019-2020}\StringTok{`}\OperatorTok{-}\StringTok{`}\DataTypeTok{2018-2019}\StringTok{`}\NormalTok{)}\OperatorTok{/}\StringTok{`}\DataTypeTok{2018-2019}\StringTok{`}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(PercentChange)) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{threechange }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{threechange }\OperatorTok{%>%}\StringTok{ }
...
\StringTok{  }\KeywordTok{row_spec}\NormalTok{(}\DecValTok{6}\NormalTok{, }\DataTypeTok{bold =}\NormalTok{ T, }\DataTypeTok{color =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{background =} \StringTok{"#FBB93C"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{kable}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{bootstrap_options =} \KeywordTok{c}\NormalTok{(}\StringTok{"striped"}\NormalTok{, }\StringTok{"condensed"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{row_spec}\NormalTok{(}\DecValTok{6}\NormalTok{, }\DataTypeTok{bold =}\NormalTok{ T, }\DataTypeTok{color =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{background =} \StringTok{"#FBB93C"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{threechange }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Change =} \KeywordTok{percent}\NormalTok{(PercentChange)) }\OperatorTok{%>%}
...
\cellcolor[HTML]{F98C0A}{\textcolor{white}{\textbf{51.08\%}}}
...
\cellcolor[HTML]{ED6925}{\textcolor{white}{\textbf{44.10\%}}}
...
\cellcolor[HTML]{D84B3E}{\textcolor{white}{\textbf{35.59\%}}}
...
\cellcolor[HTML]{BB3754}{\textcolor{white}{\textbf{34.32\%}}}
...
\cellcolor[HTML]{9B2964}{\textcolor{white}{\textbf{33.29\%}}}
...
\cellcolor[HTML]{781C6D}{\textcolor{white}{\textbf{26.37\%}}}
...
\cellcolor[HTML]{56106E}{\textcolor{white}{\textbf{25.52\%}}}
...
\cellcolor[HTML]{330A5F}{\textcolor{white}{\textbf{25.16\%}}}
...
\cellcolor[HTML]{110A30}{\textcolor{white}{\textbf{23.49\%}}}
...
\cellcolor[HTML]{000004}{\textcolor{white}{\textbf{23.40\%}}}
...
\StringTok{  }\KeywordTok{save_kable}\NormalTok{(}\StringTok{"minnesota.pdf"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{winlosslogs <-}\StringTok{ }\NormalTok{logs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{wins =} \KeywordTok{case_when}\NormalTok{(}
      \KeywordTok{grepl}\NormalTok{(}\StringTok{"W"}\NormalTok{, Outcome) }\OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{, }
      \KeywordTok{grepl}\NormalTok{(}\StringTok{"L"}\NormalTok{, Outcome) }\OperatorTok{~}\StringTok{ }\DecValTok{0}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Team, Conference) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{TotalPlays =} \KeywordTok{sum}\NormalTok{(OffensivePlays), }
    \DataTypeTok{TotalYards =} \KeywordTok{sum}\NormalTok{(OffensiveYards), }
    \DataTypeTok{DefensivePlays =} \KeywordTok{sum}\NormalTok{(DefPlays), }
    \DataTypeTok{DefensiveYards =} \KeywordTok{sum}\NormalTok{(DefYards), }
    \DataTypeTok{TotalWins =} \KeywordTok{sum}\NormalTok{(wins)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{OffensiveYPP =}\NormalTok{ TotalYards}\OperatorTok{/}\NormalTok{TotalPlays, }
    \DataTypeTok{DefensiveYPP =}\NormalTok{ DefensiveYards}\OperatorTok{/}\NormalTok{DefensivePlays) ->}\StringTok{ }\NormalTok{ypp}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bigten <-}\StringTok{ }\NormalTok{ypp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Conference }\OperatorTok{==}\StringTok{ "Big Ten Conference"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ypp }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{offense =} \KeywordTok{mean}\NormalTok{(OffensiveYPP), }
    \DataTypeTok{defense =} \KeywordTok{mean}\NormalTok{(DefensiveYPP)}
\NormalTok{    )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{oppwinlosslogs <-}\StringTok{ }\NormalTok{logs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{winloss =} \KeywordTok{case_when}\NormalTok{(}
  \KeywordTok{grepl}\NormalTok{(}\StringTok{"W"}\NormalTok{, W_L) }\OperatorTok{~}\StringTok{ }\DecValTok{0}\NormalTok{, }
  \KeywordTok{grepl}\NormalTok{(}\StringTok{"L"}\NormalTok{, W_L) }\OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{)}
\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Date }\OperatorTok{<}\StringTok{ "2020-03-19"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{oppwinlosslogs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(Opponent) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{games=}\KeywordTok{n}\NormalTok{(), }\DataTypeTok{wins=}\KeywordTok{sum}\NormalTok{(winloss)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{winpct =}\NormalTok{ wins}\OperatorTok{/}\NormalTok{games) ->}\StringTok{ }\NormalTok{opprecord}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{winlosslogs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(opprecord, }\DataTypeTok{by=}\NormalTok{(}\StringTok{"Opponent"}\NormalTok{)) ->}\StringTok{ }\NormalTok{winswithopppct}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{winswithopppct }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(winpct }\OperatorTok{>}\StringTok{ }\FloatTok{.6}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{week =} \KeywordTok{floor_date}\NormalTok{(Date, }\DataTypeTok{unit=}\StringTok{"weeks"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(week, Conference) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{wins=}\KeywordTok{sum}\NormalTok{(winloss)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Conference }\OperatorTok{%in%}\StringTok{ }\NormalTok{p5) ->}\StringTok{ }\NormalTok{qualitywins}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{scoringoffense18 <-}\StringTok{ }\NormalTok{scoringoffense }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{YEAR =} \DecValTok{2019}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stats <-}\StringTok{ }\NormalTok{stats }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{Rank=}\NormalTok{X1, }\DataTypeTok{School=}\NormalTok{X2, }\DataTypeTok{Games=}\NormalTok{X3, }\DataTypeTok{OverallWins=}\NormalTok{X4, }\DataTypeTok{OverallLosses=}\NormalTok{X5, }\DataTypeTok{WinPct=}\NormalTok{X6, }\DataTypeTok{OverallSRS=}\NormalTok{X7, }\DataTypeTok{OverallSOS=}\NormalTok{X8, }\DataTypeTok{Blank1=}\NormalTok{X9, }\DataTypeTok{ConferenceWins=}\NormalTok{X10, }\DataTypeTok{ConferenceLosses=}\NormalTok{X11, }\DataTypeTok{Blank2=}\NormalTok{X12, }\DataTypeTok{HomeWins=}\NormalTok{X13, }\DataTypeTok{HomeLosses=}\NormalTok{X14, }\DataTypeTok{Blank3=}\NormalTok{X15, }\DataTypeTok{AwayWins=}\NormalTok{X16, }\DataTypeTok{AwayLosses=}\NormalTok{X17, }\DataTypeTok{Blank4=}\NormalTok{X18, }\DataTypeTok{ForPoints=}\NormalTok{X19, }\DataTypeTok{OppPoints=}\NormalTok{X20, }\DataTypeTok{Blank5=}\NormalTok{X21, }\DataTypeTok{Minutes=}\NormalTok{X22, }\DataTypeTok{FieldGoalsMade=}\NormalTok{X23, }\DataTypeTok{FieldGoalsAttempted=}\NormalTok{X24, }\DataTypeTok{FieldGoalPCT=}\NormalTok{X25, }\DataTypeTok{ThreePointMade=}\NormalTok{X26, }\DataTypeTok{ThreePointAttempts=}\NormalTok{X27, }\DataTypeTok{ThreePointPct=}\NormalTok{X28, }\DataTypeTok{FreeThrowsMade=}\NormalTok{X29, }\DataTypeTok{FreeThrowsAttempted=}\NormalTok{X30, }\DataTypeTok{FreeThrowPCT=}\NormalTok{X31, }\DataTypeTok{OffensiveRebounds=}\NormalTok{X32, }\DataTypeTok{TotalRebounds=}\NormalTok{X33, }\DataTypeTok{Assists=}\NormalTok{X34, }\DataTypeTok{Steals=}\NormalTok{X35, }\DataTypeTok{Blocks=}\NormalTok{X36, }\DataTypeTok{Turnovers=}\NormalTok{X37, }\DataTypeTok{PersonalFouls=}\NormalTok{X38)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stats <-}\StringTok{ }\NormalTok{stats }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{starts_with}\NormalTok{(}\StringTok{"Blank"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  logs <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(logs, table)  }\CommentTok{# binding them all together}
  \KeywordTok{Sys.sleep}\NormalTok{(}\DecValTok{3}\NormalTok{)  }\CommentTok{# Sys.sleep(3) pauses the loop for 3s so as not to overwhelm website's server}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{write_csv}\NormalTok{(logs, }\StringTok{"logs.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}
    ...
    \DataTypeTok{TotalYards =} \KeywordTok{sum}\NormalTok{(OffensiveYards), }
    \DataTypeTok{DefensivePlays =} \KeywordTok{sum}\NormalTok{(DefPlays), }
    \DataTypeTok{DefensiveYards =} \KeywordTok{sum}\NormalTok{(DefYards)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{OffensiveYPP =}\NormalTok{ TotalYards}\OperatorTok{/}\NormalTok{TotalPlays, }
    \DataTypeTok{DefensiveYPP =}\NormalTok{ DefensiveYards}\OperatorTok{/}\NormalTok{DefensivePlays) ->}\StringTok{ }\NormalTok{ypp}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{averages <-}\StringTok{ }\NormalTok{ypp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{AvgOffYardsPer =} \KeywordTok{mean}\NormalTok{(OffensiveYPP), }\DataTypeTok{AvgDefYardsPer =} \KeywordTok{mean}\NormalTok{(DefensiveYPP))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{playoff_teams <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Oklahoma"}\NormalTok{, }\StringTok{"LSU"}\NormalTok{, }\StringTok{"Clemson"}\NormalTok{, }\StringTok{"Ohio State"}\NormalTok{)}

\NormalTok{playoffs <-}\StringTok{ }\NormalTok{ypp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Team }\OperatorTok{%in%}\StringTok{ }\NormalTok{playoff_teams)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-298-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-302-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-303-1.pdf}
The problems here:
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-305-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-306-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-311-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-320-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-345-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-358-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-359-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-369-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-370-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-377-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-378-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-379-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-380-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-381-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-383-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-384-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-402-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{activeplayers <-}\StringTok{ }\NormalTok{players }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(MP}\OperatorTok{>}\DecValTok{0}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(activeplayers}\OperatorTok{$}\NormalTok{FGA)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shooters <-}\StringTok{ }\NormalTok{activeplayers }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(FGA }\OperatorTok{>}\StringTok{ }\DecValTok{197}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_beeswarm}\NormalTok{(}\DataTypeTok{data=}\NormalTok{shooters, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Pos, }\DataTypeTok{y=}\StringTok{`}\DataTypeTok{TS%}\StringTok{`}\NormalTok{), }\DataTypeTok{color=}\StringTok{"grey"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{SportsData_files/figure-latex/unnamed-chunk-409-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nu <-}\StringTok{ }\NormalTok{players }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Team }\OperatorTok{==}\StringTok{ "Nebraska Cornhuskers"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(FGA}\OperatorTok{>}\DecValTok{197}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(}\StringTok{`}\DataTypeTok{TS%}\StringTok{`}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{geom_beeswarm}\NormalTok{(}
    \DataTypeTok{data=}\NormalTok{shooters, }
    \DataTypeTok{groupOnX=}\OtherTok{TRUE}\NormalTok{, }
    \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Pos, }\DataTypeTok{y=}\StringTok{`}\DataTypeTok{TS%}\StringTok{`}\NormalTok{), }\DataTypeTok{color=}\StringTok{"grey"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_beeswarm}\NormalTok{(}
    \DataTypeTok{data=}\NormalTok{nu, }
    \DataTypeTok{groupOnX=}\OtherTok{TRUE}\NormalTok{, }
    \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Pos, }\DataTypeTok{y=}\StringTok{`}\DataTypeTok{TS%}\StringTok{`}\NormalTok{), }\DataTypeTok{color=}\StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{SportsData_files/figure-latex/unnamed-chunk-411-1.pdf}
...
\StringTok{  }\KeywordTok{geom_beeswarm}\NormalTok{(}
    \DataTypeTok{data=}\NormalTok{nu, }
    \DataTypeTok{groupOnX=}\OtherTok{TRUE}\NormalTok{, }
    \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Pos, }\DataTypeTok{y=}\StringTok{`}\DataTypeTok{TS%}\StringTok{`}\NormalTok{), }\DataTypeTok{color=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_text_repel}\NormalTok{(}
    \DataTypeTok{data=}\NormalTok{nu, }
    \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Pos, }\DataTypeTok{y=}\StringTok{`}\DataTypeTok{TS%}\StringTok{`}\NormalTok{, }\DataTypeTok{label=}\NormalTok{Player))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-413-1.pdf}
