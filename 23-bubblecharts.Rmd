...
ggplot() + 
  ...
  labs(title="Nebraska: Average at football?", subtitle="The Husker's were kinda in the middle of everything, neither good nor bad at anything.", caption="Source: NCAA | By Matt Waite")  + theme_minimal() + 
  theme(
