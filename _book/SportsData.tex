...
The probability? 4.099 x 10 to the -7 power. Don't remember your scientific notation? That's .00000004099. The decimal, seven zeros and the number.

Remember, if the probability is below .05, then we determine that that this number is statistically significant. We'll talk more about statistical significance soon, but in this case, statistical significance means that our hypothesis is correct: points are different without fans than with.

Well, .000000004099 is less than .05, so we \emph{reject the null hypothesis} and we can confidently say that bubble teams are scoring more than they were when fans packed arenas.
...
My hypothesis, because we have to test if it's different, is that home court is no longer an advantage, and the home team will score less relative to the away team.
...
But two things: first, the home team is STILL scoring more than the away team on the whole.
...
Now, does this mean that the bubble hasn't impacted the magic of home court? Not necessarily. What it's saying is that this metric isn't capable of telling you that.
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-144-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-216-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-217-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-274-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-322-1.pdf}
...
\includegraphics{SportsData_files/figure-latex/unnamed-chunk-330-1.pdf}
