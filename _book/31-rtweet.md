...
## Observations: 11,523
## Variables: 90
## $ user_id                 <chr> "x17636179", "x17636179", "x17636179", "…
## $ status_id               <chr> "x1191100304940396544", "x11908526509059…
## $ created_at              <dttm> 2019-11-03 21:10:16, 2019-11-03 04:46:1…
## $ screen_name             <chr> "SeanKeeler", "SeanKeeler", "SeanKeeler"…
## $ text                    <chr> "ICYMI, #CSURams fans, a recap of @denve…
## $ source                  <chr> "Twitter Web App", "Twitter for iPhone",…
## $ display_text_width      <dbl> 269, 188, 182, 122, 135, 189, 172, 135, …
...
## $ is_quote                <lgl> FALSE, TRUE, FALSE, FALSE, FALSE, FALSE,…
## $ is_retweet              <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
## $ favorite_count          <dbl> 0, 0, 1, 116, 19, 2, 40, 23, 149, 5, 31,…
## $ retweet_count           <dbl> 0, 0, 0, 6, 1, 0, 1, 2, 5, 1, 3, 1, 0, 0…
...
## $ symbols                 <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
## $ urls_url                <chr> "tinyurl.com/y2b3kog9 tinyurl.com/yy7ntp…
## $ urls_t.co               <chr> "https://t.co/1FlAnRRgEq https://t.co/t8…
## $ urls_expanded_url       <chr> "https://tinyurl.com/y2b3kog9 https://ti…
## $ media_url               <chr> NA, NA, NA, "http://pbs.twimg.com/ext_tw…
## $ media_t.co              <chr> NA, NA, NA, "https://t.co/FSCP827hg0", "…
## $ media_expanded_url      <chr> NA, NA, NA, "https://twitter.com/HuskerS…
## $ media_type              <chr> NA, NA, NA, "photo", "photo", "photo", "…
## $ ext_media_url           <chr> NA, NA, NA, "http://pbs.twimg.com/ext_tw…
## $ ext_media_t.co          <chr> NA, NA, NA, "https://t.co/FSCP827hg0", "…
## $ ext_media_expanded_url  <chr> NA, NA, NA, "https://twitter.com/HuskerS…
## $ ext_media_type          <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
## $ mentions_user_id        <chr> "x8216772", "x8216772", "x24725032", "x1…
## $ mentions_screen_name    <chr> "denverpost", "denverpost", "DPostSports…
## $ lang                    <chr> "en", "en", "en", "en", "en", "en", "en"…
## $ quoted_status_id        <chr> NA, "x1190803840213209088", NA, NA, NA, …
## $ quoted_text             <chr> NA, "From Nebraska to Fort Collins, how …
## $ quoted_created_at       <dttm> NA, 2019-11-03 01:32:14, NA, NA, NA, NA…
## $ quoted_source           <chr> NA, "TweetDeck", NA, NA, NA, NA, NA, NA,…
## $ quoted_favorite_count   <dbl> NA, 5, NA, NA, NA, NA, NA, NA, NA, NA, 1…
## $ quoted_retweet_count    <dbl> NA, 1, NA, NA, NA, NA, NA, NA, NA, NA, 1…
## $ quoted_user_id          <chr> NA, "x24725032", NA, NA, NA, NA, NA, NA,…
## $ quoted_screen_name      <chr> NA, "DPostSports", NA, NA, NA, NA, NA, N…
## $ quoted_name             <chr> NA, "Denver Post Sports", NA, NA, NA, NA…
## $ quoted_followers_count  <dbl> NA, 34841, NA, NA, NA, NA, NA, NA, NA, N…
## $ quoted_friends_count    <dbl> NA, 395, NA, NA, NA, NA, NA, NA, NA, NA,…
## $ quoted_statuses_count   <dbl> NA, 113697, NA, NA, NA, NA, NA, NA, NA, …
## $ quoted_location         <chr> NA, "Denver, Colorado", NA, NA, NA, NA, …
## $ quoted_description      <chr> NA, "Sports news & analysis from @denver…
## $ quoted_verified         <lgl> NA, TRUE, NA, NA, NA, NA, NA, NA, NA, NA…
## $ retweet_status_id       <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
## $ retweet_user_id         <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
## $ geo_coords              <chr> "NA NA", "NA NA", "NA NA", "NA NA", "NA …
## $ coords_coords           <chr> "NA NA", "NA NA", "NA NA", "NA NA", "NA …
## $ bbox_coords             <chr> "NA NA NA NA NA NA NA NA", "NA NA NA NA …
## $ status_url              <chr> "https://twitter.com/SeanKeeler/status/1…
## $ name                    <chr> "Sean Keeler", "Sean Keeler", "Sean Keel…
## $ location                <chr> "Denver, CO", "Denver, CO", "Denver, CO"…
## $ description             <chr> "@DenverPost staffer, dad, husband, drum…
## $ url                     <chr> "https://t.co/z0eFbv9eaz", "https://t.co…
## $ protected               <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
## $ followers_count         <dbl> 5245, 5245, 5245, 30451, 30451, 30451, 3…
## $ friends_count           <dbl> 1619, 1619, 1619, 701, 701, 701, 701, 70…
## $ listed_count            <dbl> 296, 296, 296, 247, 247, 247, 247, 247, …
## $ statuses_count          <dbl> 28124, 28124, 28124, 12801, 12801, 12801…
## $ favourites_count        <dbl> 4498, 4498, 4498, 6033, 6033, 6033, 6033…
## $ account_created_at      <dttm> 2008-11-25 23:53:13, 2008-11-25 23:53:1…
## $ verified                <lgl> FALSE, FALSE, FALSE, TRUE, TRUE, TRUE, T…
## $ profile_url             <chr> "https://t.co/z0eFbv9eaz", "https://t.co…
## $ profile_expanded_url    <chr> "http://www.seankeeler.tumblr.com", "htt…
...
## $ profile_image_url       <chr> "http://pbs.twimg.com/profile_images/118…
```
